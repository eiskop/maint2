...
class Drawing extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['entity_id', 'date', 'type', 'vaultname', 'doc_aliasset', 'doc_pdmweid', 'drawing_number', 'conf_name', 'conf_quantity', 'description1', 'description2', 'description3', 'revision', 'item_name', 'creator', 'approver', 'product_responsible', 'state', 'xml_file_name', 'pdf_contents', 'pdf_contents_lc', 'pdf_contents_uc', 'xml_file_created', 'creation_date', 'approval_date', 'created'], 'required'],
            [['entity_id', 'date', 'doc_pdmweid', 'conf_name', 'conf_quantity'], 'integer'],
            [['pdf_contents', 'pdf_contents_lc', 'pdf_contents_uc'], 'string'],
